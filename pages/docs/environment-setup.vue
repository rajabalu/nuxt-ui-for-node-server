        ...
        <v-col offset-lg="2" lg="6" md="12">
          <div class="mb-6">
            <div id="intro">
              ...
              <p>Welcome to the AutoCortex Nuxt free version of the original DashUI HTML theme.</p>
            ...
            <div id="getting-started" class="py-6">
              ...
              <p class="intro-font my-3">
                A professional AutoCortex Nuxt Dashboard that comes with plenty of ready-to-use
                components that will help you to build more beautiful application.
              </p>
              <p class="intro-font my-3">
                AutoCortex is built with the most popular The Progressive JavaScript Framework
            ...
            <div id="running-in-local-environment" class="py-6">
              ...
              <div class="py-3">
                <ol>
                  ...
                  <li>
                    <h3>Install AutoCortex Nuxt Free Version</h3>
                    <p class="intro-font my-3">
                  ...
                  <li>
                    <h3>Starting AutoCortex Nuxt Free Version</h3>
                    <p class="intro-font my-3">
